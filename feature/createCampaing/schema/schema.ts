...
export const campaignSchema = z.object({
  ...
  duration_days: z
    .number({ message: "მიუთითე კამპანიის ხანგრძლივობა" })
  ...
  platforms: z
    .array(z.enum(["instagram", "tiktok", "youtube", "facebook"]))
    .min(1, { message: "აირჩიე პლათფორმა შენი კამპანიისთვის" }),
  tags: z.array(z.string().min(1)).optional(),
  media: z
    .array(
      z.object({
        name: z.string(),
        url: z.string(), // ← .url() მოვაშორეთ — აღარ ამოწმებს valid URL-ად
...
export type CampaignSchema = z.infer<typeof campaignSchema> & {
  media?: Array<{
    ...
    type: "image" | "video";
    source?: "file" | "link";
    file?: File; // Extend for file handling (Zod ignores this)
  }>;
};

          ...
          <div className="flex-1 min-w-[300px]">
            ...
            <div className="max-w-[543px] flex gap-4 items-center">
              ...
              <input
                ...
                className="w-[543px] border border-[#E3E8EF] rounded-[8px] px-3 py-2 
                           text-[18px] text-[#00000083] font-[700] outline-none"
              />
            </div>
          </div>
        ...
        <div className="flex-1 min-w-[300px]">
          ...
          <div className="w-full flex gap-4 items-center">
            <input
              ...
              className="w-full border border-[#E3E8EF] rounded-[8px] px-3 py-2 
                           text-[18px] text-[#00000083] font-[700] outline-none"
            />
          </div>
        </div>
